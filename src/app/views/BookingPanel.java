...
public class BookingPanel extends javax.swing.JPanel {
    ...
    public void prepareTable(){
        ...
        model.addColumn("#");
        model.addColumn("Booker naam");
        model.addColumn("Trip naam");
        model.addColumn("Datum");
        try {
            String query = "SELECT B.*, T.name AS bookerName, TR.name AS tripName FROM Booking B JOIN Booker BO ON B.booker_id = BO.id JOIN Traveller T ON BO.traveller_id = T.id JOIN Trip TR ON B.trip_id = TR.id";
            ...
            while (rs.next()) {
                ...
                model.insertRow(model.getRowCount(), new Object[]{id, bookerName, tripName, date});
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Booking overzicht");
