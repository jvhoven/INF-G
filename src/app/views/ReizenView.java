 ...
 * @author Henk-PC
 */
public class ReizenView extends javax.swing.JFrame {

    /**
     * Creates new form ReizenView
     */
    public ReizenView() {
        initComponents();
        ...
        jTabbedPane1.add("Traveller", new TravellerPanel());
        jTabbedPane1.add("Booking", new BookingPanel());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReizenView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReizenView().setVisible(true);
            }
        });
    }
