 ...
 * @author MatthijsSmit
 */
public class TravellerPanel extends javax.swing.JPanel {

    /**
     * Creates new form ExcursionPanel
     */
    public TravellerPanel() {
        initComponents();
        prepareTable();
    }
    ...
    public void prepareTable(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                model.insertRow(model.getRowCount(), new Object[]{id, name, birth_date, gender});
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Traveller overzicht");
